...
#define	TSG_COMPARE_MASK_HDAY		0x0	// hundreds days ...
#define	TSG_COMPARE_MASK_TDAY		0x1	// tens days ...
#define	TSG_COMPARE_MASK_UDAY		0x2	// units days ...
#define	TSG_COMPARE_MASK_THOUR		0x3	// tens hours ...
#define	TSG_COMPARE_MASK_UHOUR		0x4	// units hours ...
#define	TSG_COMPARE_MASK_TMIN		0x5	// tens mins ...
#define	TSG_COMPARE_MASK_UMIN		0x6	// units mins ...
#define	TSG_COMPARE_MASK_TSEC		0x7	// tens secs ...
#define	TSG_COMPARE_MASK_USEC		0x8	// units secs ...
#define	TSG_COMPARE_MASK_HMSEC		0x9	// hundreds msec ...
#define	TSG_COMPARE_MASK_TMSEC		0xa	// tens msec ...
#define	TSG_COMPARE_MASK_UMSEC		0xb	// units msec ...
#define	TSG_COMPARE_MASK_DISABLE	0xc	// new boards: disable time compare output

struct tsg_compare_time {
	uint16_t day;
	uint8_t hour;
	uint8_t min;
	uint8_t sec;
